Public Class Agenda
    ...
    Private Sub PictureBox4_MouseUp(sender As Object, e As MouseEventArgs) Handles PictureBox4.MouseUp, PictureBox5.MouseUp
        v_panelMove = False
    End Sub
    ...
    Private Sub calendario_Paint(sender As Object, e As PaintEventArgs) Handles calendario.Paint
